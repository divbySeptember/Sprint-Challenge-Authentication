...
1. What is the purpose of using _sessions_? sessions are used to store user specific information that persist across requests
2. What does bcrypt do to help us store passwords in a secure manner?  bcrypt hashes the passwords to make them impossible to read and decrypt
3. What does bcrypt do to slow down attackers? bcrypt hashes and adds salts to slow down attackers
